...
class LoyalLocators:
    ...
    SECOND_FROM_TOP_PURCHASE_LOUPE = (By.XPATH,'//table[@ng-if = "purchases.length"]/tbody/tr[2]//button')
    ...
    ADDED_BONUS_CANCELLED = (By.XPATH, "//*[.='Бонус']/following-sibling::td[2]/div[@class='state-icon canceled']")
    PAID_BONUS_CONFIRMED = (By.XPATH, "//*[.='Оплата']/following-sibling::td[2]/div[@class='state-icon confirmed']")
    PAID_BONUS_CANCELLED = (By.XPATH, "//*[.='Оплата']/following-sibling::td[2]/div[@class='state-icon canceled']")
